...
const Examen = sequelize.define('Examen', {
  ...
  puntaje_pregunta_buena: { type: DataTypes.DECIMAL(5, 2),  allowNull: false, defaultValue: 4.00 },
  puntaje_pregunta_mala:  { type: DataTypes.DECIMAL(5, 2),  allowNull: false, defaultValue: 1.00 },
